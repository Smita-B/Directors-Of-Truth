...
if($_SERVER["REQUEST_METHOD"] == "POST")
    ...
    $_SESSION['PSNAME']=$PSNAME;
		...
		<div class="wrapper">
    	<div class="left">
        <img src="<?php echo $photo; ?>" width="180" height="180">
        <h3><?php echo $PSNAME ?> Police Station</h3><br><br>
        <h4>Officer In Charge</h4><p><?php echo $Oincharge ?></p><br>
  ...
  <center><table>
  <tr>	
	<td><a target="_ " href="update_police.php?OC=<?php echo $Oincharge ?> & PH=<?php echo $phone ?> "><input type="button" value="Update" class="button"></a></td>
  <td><a target="_ " href="ShowPolice.php"><input type="button" value="Back" class="button"></a></td>
  </tr></table></center>
  </div>
    <!--<?php echo $photo; ?>-->
</body>
