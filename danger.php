<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST")
    {
        $pname=$_POST['ps'];
        $_SESSION['ps']=$pname;
        $command = escapeshellcmd('Python "C:/xampp/htdocs/DOT/fuzzyDisplay.py"');
        shell_exec($command);
        header("location:showdanger.php");
    }
$conn->close();
?>
<!doctype html>
...
<body>
  <div class="container">
	...
	<CENTER>
	<br><br><table><tr>
	<td id="text" class="txt" style="padding-bottom: 15px;"><h2>CHOOSE POLICE STATION </h2></td></tr><tr><td style="text-align: center;">
    <select  name="ps" size="1" style="width:150px;height: 30px; background-color: #fef674; border-radius:40px;">
