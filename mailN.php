	...
	{	
            ...
            if ($result->num_rows > 0) 
			{
				while($row = $result->fetch_assoc())
				{
					...
					$mail->Body    = 'ID Verification Result: No possible criminal history found but given ID does not exist. Contact nearest police station for farther information.';
