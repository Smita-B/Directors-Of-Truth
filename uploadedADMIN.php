...
if($_SERVER["REQUEST_METHOD"]=="POST")
    {
            ...
            if($result)
            {
                ...
                $command = escapeshellcmd('Python "C:\xampp\htdocs\DOT\facechenaADMIN.py"');
                //$command = escapeshellcmd('Python "C:/xampp/htdocs/Dot land/facechena2.py"');
        ...
        {
            header("Location:faceADMIN.php"); // Auto redirect 
            exit;
        }
