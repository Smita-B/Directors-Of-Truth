...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    if(empty($username_err) and empty($password_err))
    {
        ...
        $sql=mysqli_query($conn,"select NAME,PASSWORD,REG_ID from USER_REGISTRATION where Binary USERNAME='$sanitized_userid'");
        if($sql)
        {
            ...
            if($sql->num_rows == 1)
            {
                ...
                {
                    $result=mysqli_query($conn,"insert into USER_LOGIN(USER_ID) values('$REG_ID')");
                    if($result)
                    {
                        $_SESSION['NAME']=$NAME;
...
<body>
    ...
    <div class="container">
        ...
        <div class="form signup">
            ...
            <?php
                echo "<center><font color='yellow'>" . $msg . "</font></center>";
            ?>
            </div>
            <p><a href="Forgot.php" class="login">Forgot Password?</a></p>
        </div>
