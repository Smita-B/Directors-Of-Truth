...
img_path='Empty'
#path = 'E:/faces/'
#path = 'C:/xampp/htdocs/Dot land/faces'
path = 'C:/xampp/htdocs/DOT/Missing_images'
...
#img = cv2.imread('C:/xampp/htdocs/Dot land/'+img_path)
...
#based on the index value determine the name and display it Image.
    ...
    if(name=="Unknown"):
        ...
        op=str(Session_Id)+" Closest match for Name: "+str(arg1)+" with accuracy of "+str(p_dist)+"%."
